...
public class TestProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            String sql="CREATE TABLE " + TABELL + "(" + _ID + " INTEGER PRIMARY KEY," + TITTEL + " TEXT);";
            Log.d("DatabaseHelper", " oncreatedsql" + sql);
            db.execSQL(sql);
        }
        @Override
    ...
    public String getType(Uri uri) {
        switch(uriMatcher.match(uri)) {
            case MBOK: return "vnd.android.cursor.dir/vnd.example.bok";
            case BOK: return "vnd.android.cursor.item/vnd.example.bok";
