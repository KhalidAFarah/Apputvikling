...
public class Dialog extends DialogFragment {
    ...
    public android.app.Dialog onCreateDialog(Bundle savedInstanceState) {
        return new AlertDialog.Builder(getActivity()).setTitle(R.string.tøm_tittel).setMessage(R.string.tøm_desc).setPositiveButton(R.string.OK, new DialogInterface.OnClickListener() {
                    @Override
